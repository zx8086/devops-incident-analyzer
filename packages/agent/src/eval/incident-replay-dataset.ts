...
export const INCIDENT_REPLAY_DATASET: EvalExample[] = [
	...
	},
	{
		...
		// localcore-service; multi-layer upstream dependency chain through xxxxxxxxxx.pvhcorp.com.
		inputs: {
			query:
	...
	},
	{
		...
		outputs: {
			...
			referenceFindings: {
				elastic:
					"52 occurrences of error group bf741f1573851845 in the incident window, peaking in a 5-minute burst at 17:05-17:10Z across three distinct ECS nodes. Kong access logs for the seasons-v3 upstream show 1,360 of 4,421 requests returning 404 (31% error rate) with 404 responses cached by Kong, amplifying the impact.",
				kafka:
