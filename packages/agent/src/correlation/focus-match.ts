...
// lifted here verbatim so every extractor and correlation/rules.ts share one
// matcher instead of each re-implementing (or drifting on) service-name matching.
