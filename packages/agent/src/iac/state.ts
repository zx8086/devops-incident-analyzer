...
export const IacState = Annotation.Root({
	...
	// SIO-1185: the failure taxonomy class behind failureHint (state-lock | flaky | lint |
	// environment | real | unknown), driving the class-specific closing line.
	failureClass: Annotation<string>({ reducer: last, default: () => "" }),
