...
class LangSmithTracingTester {
	...
	private async testEnvironmentConfiguration(): Promise<void> {
		...
		await this.runTest("Required Environment Variables", () => {
	...
	private async testTracingInitialization(): Promise<void> {
		...
		await this.runTest("Tracing Utilities Import", async () => {
			try {
		...
		await this.runTest("LangSmith Client Initialization", async () => {
			try {
	...
	private async testToolRegistration(): Promise<void> {
		...
		await this.runTest("Tool Registration System Import", async () => {
			try {
