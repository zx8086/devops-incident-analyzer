...
export function registerQueryResource(server: McpServer, bucket: Bucket, registry: ResourceRegistry): void {
	...
	const readQuery = async (uri: URL, { scope, encodedQuery }: TemplateVariables) => {
