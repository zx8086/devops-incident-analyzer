...
//
// SIO-1118: regression test -- an SDK error on upsert (e.g. a write TimeoutError)
// or invalid JSON content must surface as a structured error envelope with
// isError:true, not an uncaught throw that the agent categorizes "unknown"
// (degrading) and uses to cap confidence. Mirrors the SIO-1117
// getDocumentById.test.ts pattern.
