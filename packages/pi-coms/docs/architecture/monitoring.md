...
| Cost | daily | Yesterday vs the trailing 14-day baseline; alerts when over by more than `PI_MONITOR_COST_ABS` (fleet default $100; the percentage gate `PI_MONITOR_COST_PCT` is off at 0, SIO-1680) | Once per date |
