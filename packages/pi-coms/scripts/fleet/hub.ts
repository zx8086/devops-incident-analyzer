...
export async function listAgents(baseUrl: string, token: string): Promise<AgentCard[]> {
	const resp = await fetch(`${baseUrl}/v1/agents?project=default&include_explicit=true`, {
