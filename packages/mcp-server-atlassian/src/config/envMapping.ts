...
export const envMapping: readonly EnvMappingEntry[] = [
	...
	// atlassian
	{ configPath: "atlassian.baseUrl", envVar: "ATLASSIAN_BASE_URL", default: configDefaults.atlassian.baseUrl },
	{ configPath: "atlassian.email", envVar: "ATLASSIAN_EMAIL", default: "" },
	{ configPath: "atlassian.apiToken", envVar: "ATLASSIAN_API_TOKEN", default: "" },
	{ configPath: "atlassian.cloudId", envVar: "ATLASSIAN_CLOUD_ID", default: "" },
	{ configPath: "atlassian.timeout", envVar: "ATLASSIAN_TIMEOUT", default: configDefaults.atlassian.timeout },
	{ configPath: "atlassian.retryAttempts", envVar: "ATLASSIAN_RETRY_ATTEMPTS", default: configDefaults.atlassian.retryAttempts },
	{ configPath: "atlassian.retryDelay", envVar: "ATLASSIAN_RETRY_DELAY", default: configDefaults.atlassian.retryDelay },
