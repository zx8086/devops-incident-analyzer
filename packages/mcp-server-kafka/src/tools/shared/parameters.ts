...
export const TopicFilterParam = z.string().optional().describe("Regex pattern to filter topic names");

export const GroupFilterParam = z.string().optional().describe("Regex pattern to filter consumer group names");
