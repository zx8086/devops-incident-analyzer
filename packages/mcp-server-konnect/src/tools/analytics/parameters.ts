...
export type QueryApiRequestsArgs = z.infer<typeof queryApiRequestsParameters>;
export type GetConsumerRequestsArgs = z.infer<typeof getConsumerRequestsParameters>;
