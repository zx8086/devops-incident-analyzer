...
export type ListControlPlanesArgs = z.infer<typeof listControlPlanesParameters>;
export type GetControlPlaneArgs = z.infer<typeof getControlPlaneParameters>;
export type ListControlPlaneGroupMembershipsArgs = z.infer<typeof listControlPlaneGroupMembershipsParameters>;
export type CheckControlPlaneGroupMembershipArgs = z.infer<typeof checkControlPlaneGroupMembershipParameters>;
export type CreateControlPlaneArgs = z.infer<typeof createControlPlaneParameters>;
export type UpdateControlPlaneArgs = z.infer<typeof updateControlPlaneParameters>;
export type DeleteControlPlaneArgs = z.infer<typeof deleteControlPlaneParameters>;
export type ListDataPlaneNodesArgs = z.infer<typeof listDataPlaneNodesParameters>;
export type GetDataPlaneNodeArgs = z.infer<typeof getDataPlaneNodeParameters>;
export type CreateDataPlaneTokenArgs = z.infer<typeof createDataPlaneTokenParameters>;
export type RevokeDataPlaneTokenArgs = z.infer<typeof revokeDataPlaneTokenParameters>;
export type ListDataPlaneTokensArgs = z.infer<typeof listDataPlaneTokensParameters>;
export type GetControlPlaneConfigArgs = z.infer<typeof getControlPlaneConfigParameters>;
export type UpdateControlPlaneConfigArgs = z.infer<typeof updateControlPlaneConfigParameters>;
