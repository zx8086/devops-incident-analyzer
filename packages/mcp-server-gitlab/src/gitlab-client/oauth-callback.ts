// src/gitlab-client/oauth-callback.ts
...
export async function waitForOAuthCallback(): Promise<OAuthCallbackResult> {
	return new Promise<OAuthCallbackResult>((resolve, reject) => {
		...
		log.info({ port: OAUTH_CALLBACK_PORT, path: OAUTH_CALLBACK_PATH }, "OAuth callback server started");
	});
}
