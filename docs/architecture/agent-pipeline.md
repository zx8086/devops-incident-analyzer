...
| couchbase | ~39 (SIO-1107 adopted the official Couchbase tools: buckets, INFER-based schema, EXPLAIN, Index Advisor, covering-index detectors) | 8 (system_vitals, fatal_requests, slow_queries, expensive_queries, index_analysis, node_status, document_ops, query_execution) | 3-8 |
