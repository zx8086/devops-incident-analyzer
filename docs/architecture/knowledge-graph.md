...
Reached at `http://127.0.0.1:9087/mcp`. Seven **curated** read-only tools are always registered (`tools/curated.ts`), each binding its args as params (injection-safe):
