...
| 2026-07-26 | Added the [Model Upgrade Checklist](development/model-upgrade-checklist.md) (SIO-1224) after the SIO-1213 Sonnet 5 / Opus 4.8 bump caused five production failures in one day. Ten pre-merge gates built on the new `bun run model:probe` conformance probe, whose committed reports live in `reference/model-probes/`. |
