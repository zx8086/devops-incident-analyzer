...
- Observability: CloudWatch metrics and alarms, CloudWatch Logs and Logs Insights. (X-Ray tools exist but are NOT populated in these estates -- traces ship via OpenTelemetry to Elastic APM; see the Estate Observability Topology rule.)
